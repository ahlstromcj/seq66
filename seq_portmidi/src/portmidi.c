 ...
 *  client performers an explicit function call on the stream, e.g. an input or
 ...
 *  data is called, to support Seq66's midibus object.
 *
 * \return
 ...
 *
 *  For Seq66, we have added a check for pm_descriptors being null.
