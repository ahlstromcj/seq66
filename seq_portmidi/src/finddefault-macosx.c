 ...
 *
 *  Roger Dannenberg, June 2008, some fixes and reformatting by Chris
 *  Ahlstrom.  However, since this uses Java "prefs", and Seq66 already has
 *  its own configuration file, this code will not be used. Kept for any
