 ...
 *
 *  The Seq66 keystroke configuration sections in the "rc" file currently
 *  rely on the Gdk (Gtkmm) keystroke handling.  The Seq66 keystroke
 ...
 *
 *      -   The Gtkmm 2.4 version of Seq66 has access to all keycodes
