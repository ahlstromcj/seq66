...
public:
    ...
    bool show_timed_error_box
    (
        const std::string & msgtext, int timeout = 5000
    );
...
private:
    ...
    void remove_edit_tab_frame ();
    void remove_event_tab_frame ();
    ...
    bool make_edit_frame (int seqid);
...
private slots:
    ...
    void slot_show_hide ();
    void slot_midi_learn_help ();
    void slot_midi_learn_tutorial ();
    void slot_midi_learn_cheat_sheet ();
