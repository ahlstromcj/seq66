...
/**
 *  Provides an encapsulation of editable combo-box support. The 0th item
 *  in this combo list always contains the default or current value.
 */
...
extern const tokenization & rec_style_items ();
