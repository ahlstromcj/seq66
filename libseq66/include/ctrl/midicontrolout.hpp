...
public:
    ...
    bool modify_macro (const tokenization & tokens)
    {
        return m_macro_events.modify(tokens);
    }
    ...
    bool find_macro (const std::string & macnam) const
    {
        return m_macro_events.find(macnam);
    }
