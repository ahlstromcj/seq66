 ...
 *
 *  In these macros, the "s" parameter is a QString, toUtf8() returns a
 *  QByteArray, and constData() returns a pointer to the data inside the
 *  QByteArray.
 ...
 *  lives long enough.
 *
 *  Other potential macros a la the VLC project.
 *
