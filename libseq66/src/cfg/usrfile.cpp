...
usrfile::write ()
{
    ...
    file <<
"# 'usr' file. Edit it and place it in $HOME/.config/seq66. It allows aliases\n"
"# (alternate names) to each MIDI bus/port, channel, and control code, per\n"
"# channel. It has options not present in Seq24.\n"
        ;
...
"#\n"
"# In these definitions, channels are counted from 0-15, not 1-16. Instruments\n"
"# not set here are set to -1 and are GM (General MIDI). These labels are shown\n"
"# in MIDI Clocks, Inputs, the pattern editor buss, channel, and event drop-\n"
"# downs.  To disable entries, set counts to 0.\n"
        ;
    ...
    file << "\n"
"# In these MIDI instrument definitions, active controller numbers (i.e.\n"
"# supported by the instrument) are paired with the (optional)\n"
...
"# [user-interface-settings]\n"
"#\n"
"# Configures some user-interface elements.  Many became obsolete and were\n"
"# removed in version 5 of this file. Also see [user-ui-tweaks]. The grid holds\n"
"# Qt buttons. For styling, use Qt themes/style-sheets.\n"
"#\n"
...
"#\n"
"# 'default-zoom' is the initial zoom for the piano rolls. From 1 to 512, default\n"
...
"# pattern are applied to all patterns, or separately to each.  These values are\n"
"# stored in the MIDI file, either in the global SeqSpec (if true) or in each\n"
"# track (if false).\n"
"#\n"
"# 'progress-bar-thick specifies a thicker progress bar.  Default is 1 pixel;\n"
"# thick is 2 pixels if set to true. Also makes the progress box\n"
...
"# 'buss-override' sets the output port for all patterns, for testing or\n"
"# convenience.  Don't save the MIDI file unless you want to save the buss value!\n"
"#\n"
...
"# 'bpm-step-increment' affects the spinner and MIDI control. For 1 decimal point\n"
...
"# '-o log=filename.log'. The name here is used for the no-name '-o log' option.\n"
"\n[user-options]\n\n"
        ;
