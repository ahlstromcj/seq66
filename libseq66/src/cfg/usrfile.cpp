...
usrfile::write ()
{
    ...
    file << "\n"
        "# [user-interface-settings]\n"
        "#\n"
        "# Specifies the configuration of user-interface elements.  Many were\n"
        "# rendered obsolete and removed in version 5 of this file. The grid\n"
        "# is now always Qt buttons. To use a flat style, use Qt themes\n"
        "# or style-sheets.\n"
        "#\n"
    ...
    file << "\n"
        ...
        "# 0.01 is good, but 0.05 is faster.  Set the page increment larger\n"
        "# than the step increment; it's used with the Page-Up/Page-Down keys\n"
        "# in the BPM spinner. The BPM minimum/maximum set the range in tempo\n"
        "# graphing; defaults to 0.0 to 127.0. Decrease it for a magnified\n"
        "# view of tempo.\n"
        "\n[user-midi-settings]\n\n"
        ;
    ...
    file << "\n"
        "# [user-options]\n"
        "#\n"
        "# These settings specify -o or --option switch values, which expands\n"
        "# the number of options. 'daemonize' is used in seq66cli to indicate\n"
        "# that the application should be gracefully run as a service.\n"
