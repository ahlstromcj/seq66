...
int
midibus_impl::api_poll_for_midi ()
{
...
bool
midibus_impl::api_get_midi_event (event * inev)
{
...
void
midibus_impl::api_play (event * e24, midibyte channel)
{
    if (not_nullptr(m_rt_midi))
...
void
midibus_impl::api_continue_from (midipulse tick, midipulse beats)
{
    if (not_nullptr(m_rt_midi))
...
void
midibus_impl::api_clock (midipulse tick)
{
    if (not_nullptr(m_rt_midi))
