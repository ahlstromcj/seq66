...
\label{subsubsec:menu_file_import_project_configuration}
   ...
   to stop and then start \textsl{Seq66}.
   If importing into a normal session, \textsl{Seq66} will
   restart itself automatically. Be aware!
...
\end{figure}
   ...
   \itempar{MIDI Buss}{record!thru buss}
