...
\end{figure}
   ...
   \sectionref{sec:configuration_ctrl},
   \sectionref{sec:configuration_drums},
   \sectionref{sec:configuration_rc_style_sheet}, and
   \sectionref{sec:configuration_rc_style_patches}.
