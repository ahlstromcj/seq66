...
\subsubsection{Menu / File / Export / Export Project Configuration}
\label{subsubsec:menu_file_export_project}
   ...
   At the present time, any file specified in a play-list are
   \textsl{not} copied.
...
%  \includegraphics[scale=0.75]{main-menu/edit/preferences/midi_input_tab.png}
   \includegraphics[scale=0.95]{main-menu/edit/preferences/midi_input_tab-2.png}
...
\begin{figure}[H]
   \centering 
   \includegraphics[scale=0.80]{main-menu/edit/preferences/midi_pattern_tab.png}
