...
\label{subsubsec:menu_help_midi_learn}
   ...
   This entry brings up a dialog giving a short description of how to use the
   MIDI Learn manager.
   It's just enough to jog one's memory after reading
   \sectionref{sec:midi_import_export}.
