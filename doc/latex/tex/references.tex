...
\begin{thebibliography}{99}
   ...
   \bibitem{krumhansl}
   Corenti-Lcs.
   \emph{Music Key Finder}
   \url{https://github.com/Corentin-Lcs/music-key-finder}.
   2024.
   ...
   2002.
   For setting up ALSA virtual ports, see this
   section: "10. HOWTO Use MIDI Sequencers With Softsynths",
   specifically section 10.2.
