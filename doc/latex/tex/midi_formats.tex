...
\label{subsubsec:midi_format_header}
   ...
   (The highest possible value is 0x7FFF = 32767 but
   \textsl{Seq66} limits it to 1920 for performance reasons.)
   \textsl{Seq66} and its precursor, \textsl{Seq24}, default to 192.
