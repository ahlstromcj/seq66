...
\label{subsubsec:midi_format_track_seqspec_seq_edit_mode}
   ...
   in \textsl{Seq66} it is currently not implemented, nor read nor written.
   It is more suited to a transitory status; it is also better determined
   by the transposable status of a pattern.
...
\label{subsubsec:midi_format_track_seqspec_seq_loopcount}
   ...
   not compatible with playing the tune in \textbf{Song} mode.
