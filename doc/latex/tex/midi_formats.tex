...
\label{subsubsec:midi_format_track_seqspec_triggers}
   ...
   This \texttt{SeqSpec} is no longer used, and is flagged as an error if
   encountered.
...
\label{subsubsec:midi_format_track_seqspec_triggers_new}
...
\label{subsubsec:midi_format_track_seqspec_trig_transpose}
   ...
   This is an extension to \texttt{c\_triggers\_new} that adds a value to use to
