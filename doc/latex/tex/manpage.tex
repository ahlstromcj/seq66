...
%  \textsl{Seq66} is a real-time MIDI sequencer. It was created to
...
%     \texttt{\textasciitilde/.config/sequencer66/sequencer66.usr} files.
      ...
      note.
      This mode is also used if \textsl{Seq66} is invoked as the
   ...
   \optionpar{-a}{--auto-ports}
      \textsl{Seq66} will attach the system's existing ALSA ports.
   ...
   The current Seq66 project homepage is a git repository at
