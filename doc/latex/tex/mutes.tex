...
\end{figure}
   ...
   \itempar{Group Table}{mute master!table}
   ...
   Currently, none of the items in this table are editable.
   ...
   \itempar{Mute-Groups}{mute master!groups}
   ...
   \itempar{Group Patterns}{mute master!patterns}
   ...
   \itempar{Set Mutes}{mute master!set mutes}
   ...
   \itempar{Mutes File}{mute master!mutes file}
   ...
   \itempar{Save File}{mute master!save file}
   ...
   \itempar{Write Format}{mute master!write format}
   ...
   \itempar{Clear All Mutes}{mute master!clear all mutes}
      This button will clear every mute group. Use it carefully!

   \itempar{Trigger Mode}{mute master!trigger mode}
   ...
   \itempar{Pattern Offset}{mute master!pattern offset}
   ...
   \itempar{Up/Down Buttons}{mute master!up/down buttons}
