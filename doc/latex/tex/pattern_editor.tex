...
\label{subsec:pattern_editor_piano_roll}
   ...
   The piano roll can show notes, a background pattern, a scale, and tempo
   events.  Notes are shown as narrow rectanges; the pattern and scale are
   shown as bars running the whole length of the piano roll;
   and tempo events are shown as small circles accompanied by a number.
...
\label{subsubsec:pattern_editor_other_keys}
   ...
   \begin{itemize}
      ...
      \item
         ...
         the pattern.  These notes are indicated by a magenta color instead of
         the normal color.  This items is a stop-gap until we can figure out
...
\begin{figure}[H]
   \centering 
  \includegraphics[scale=0.75]{pattern-editor/lfo.png}
...
%  Note the controls in this window:
   ...
   \begin{enumber}
      ...
      \item \textbf{Use Measures}.
         ...
         Useful to modify long patterns.
