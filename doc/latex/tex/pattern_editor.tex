...
\end{figure}
   ...
   \begin{itemize}
      ...
      \item \textbf{Create Macro}.
         If enabled and click, then the macro is added to the list of
         macros in the 'ctrl' configuration file, and that file is marked to be
         saved at exit.
      \item \textbf{Insert (N)RPN}.
         Clicking this button adds the RPN/NRPN event to the pattern
