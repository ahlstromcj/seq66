...
\begin{figure}[H]
   ...
   \caption{External Pattern Editor Window Additions for 0.99.24}
...
\begin{figure}[H]
   \centering 
   \includegraphics[scale=1.00]{pattern-editor/selection_options.png}
   \caption{Pattern Editor Selection Options}
   \label{fig:pattern_editor_window_selection_options}
\end{figure}
