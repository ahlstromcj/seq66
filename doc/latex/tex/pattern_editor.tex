...
\label{subsec:pattern_editor_rpn_nrpn_dialog}
   ...
   It inserts multiple events at once based on the settings in the dialog.
...
\end{figure}
   ...
   \begin{itemize}
      \item \textbf{Select Control}.
         ...
         are not yet implement.
         The \textbf{Other (arbitrary data)} allows typing or
      ...
      \item \textbf{(N)RPN parameter no.}.
         ...
         Note that parameter numbers are limit to 14-bits (0 to 16383).
      ...
      \item \textbf{RPN/NRPN parameter value}.
         Type the desired parameter value here.
      ...
      \item \textbf{Insert (N)RPN}.
         Clicking this button adds the RPN/NRPN or "other" events to the pattern
         at the timestamp shown in the timestamp text box.
      \item \textbf{Send (N)RPN}.
   ...
   There is a lot more that could be done with this macro editor.
