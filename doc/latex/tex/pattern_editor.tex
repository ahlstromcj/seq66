...
\end{figure}
   ...
   \begin{itemize}
      \item \textbf{Select Control}.
         The main purpose of this group is to select either an RPN or an
         NPRN event.
         One can also choose to enter a data event alone, but
         there is not much reason to do that.
      ...
      \item \textbf{(name of macro)}.
         Entering a short name into this text box enables the
         \textbf{Create Macro} button.
      ...
      \item \textbf{Create Macro}.
         If enabled and click, then the RPN events are added as a macro
         to the list of macros in the 'ctrl' configuration file,
         and that file is marked to be saved at exit.
      \item \textbf{Send (N)RPN}.
         Clicking this button sends the RPN/NRPN events to the
         MIDI Control Out (display) buss.
      \item \textbf{Insert (N)RPN}.
         Clicking this button adds the RPN/NRPN events to the pattern
         at the timestamp shown in the timestamp text box.
      \item \textbf{Close}.
         All this button does is closed the dialog.
   \end{itemize}
