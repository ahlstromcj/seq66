...
\end{figure}
   ...
   That figure does not show recent new features; they are shown
   in the figure below:
...
\end{figure}
   ...
   \begin{enumber}
      ...
      \item \textbf{RPN/NRPN}.
         This entry allows for the creation of a complete RPN or NRPN
         series of parameter change events, from the start to the data
...
\label{subsubsec:pattern_editor_left_buttons_scale_chord_display}
...
\label{subsubsec:pattern_editor_left_buttons_scale_chord_filtering}
...
\label{subsec:pattern_editor_rpn_nrpn_dialog}
   ...
   \textbf{Note:}
   This dialog cannot look up MIDNAM data in order to populate the
   parameter names for NRPN.
