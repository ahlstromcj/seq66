...
%  Note the controls in this window:
   ...
   \itempar{Live Loop Counter}{pattern editor!live loop counter}
   ...
   pattern acts like a "one-shot" loop.  This can save having quickly use
   queuing to handle an intro phrase.
