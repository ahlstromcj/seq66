...
\label{subsubsec:pattern_editor_other_keys}
   ...
   \begin{itemize}
      ...
      \item
         ...
         \textbf{\texttt{u}}.
         Pressing the \texttt{u} key will remove any unlinked notes found
         in the pattern.  These notes are indicated by a magenta color instead of
         the noraml color.
         This items is a stop-gap until we can figure out the best way to
         prevent unlinked notes while handling recording of notes near the end of
         the pattern length.
      \item
