...
\begin{figure}[H]
   \centering 
   \includegraphics[scale=1.00]{pattern-editor/rpn-option.png}
...
\end{figure}
   ...
   \begin{itemize}
      ...
      \item \textbf{Use "fine" events}.
         ...
         The "fine" controllers are supplied by General MIDI version 2.
      ...
      \item \textbf{(N)RPN parameter no.}.
         ...
         cannot be edited.
         If NRPN is selected, then the number of the parameter can be
         typed here.
      ...
      \item \textbf{Create Macro}.
         ...
         saved at exit.
      \item \textbf{Insert/Append}.
         Clicking this button adds the RPN/NRPN event at the timestamp
         shown in the timestamp text box.
      \item \textbf{Cancel}.
