...
% \end{figure}
   ...
   \begin{enumber}
      ...
      \item \textbf{Transposable}
      \item \textbf{Chord Generation Reset} and \textbf{Chord Generation}
...
%  pattern, useful for live intro patterns, for example.)
   ...
   The button next to this dropdown turns chord generation off.
...
%  \figureref{fig:pattern_window_right_click_midi_bus}.
   ...
   If instruments are defined in the 'usr' configuration file
