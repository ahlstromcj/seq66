...
\end{figure}
   ...
   That figure does not show recent new feature; they are shown below:
   ...
   \begin{itemize}
      ...
      \item New buttons (including buttons reserved for the future).
...
\begin{figure}[H]
   ...
   \caption{External Pattern Editor Window Additions for 0.99.22}
...
\label{subsec:pattern_editor_right_buttons}
   ...
   \begin{enumber}
      ...
      \item \textbf{Reserved for Expansion (3 buttons)}
   \end{enumber}
