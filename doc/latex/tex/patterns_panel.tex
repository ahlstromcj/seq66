...
\end{figure}
   ...
   Note that the main window always shows the set of the currently
   focussed external Live window.
   We are not sure if this is a bug or a feature.
   Also note that the right-click menu has some items removed, as indicated by
...
%  and, if present, the set notepad text for each "mainwnd" set.
%
