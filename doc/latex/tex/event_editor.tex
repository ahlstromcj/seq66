...
\label{subsec:event_editor_fields}
   ...
   The next figure shows version 0.99.22's state.

\begin{figure}[H]
   \centering
   \includegraphics[scale=0.65]{event-editor/event-editor-new.png}
   \caption{Event Editor / New Arrangement}
   \label{fig:event_editor_new_arrangement}
\end{figure}
   ...
   \begin{enumber}
      ...
      \item \textbf{Time}.
         ...
         The button next to it can be used to increase the length
