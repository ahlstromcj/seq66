...
\label{subsec:sessions_nsm}
   ...
   \index{sessions!nsm}
   NSM support in \textsl{Seq66} is well underway, but still in progress.
...
%  want to run \textsl{Seq66} under \textsl{NSM} and create a configuration in
%  the
