...
\label{sec:sessions}
   ...
   \begin{enumber}
      ...
      \item \textbf{Non Session Manager}
         ...
         offshoots such as \textsl{Agordejo} (\cite{agodejo}}
...
\end{verbatim}
   ...
   As the next section shows, if one wants to start with a blank configuration,
   simply move or hide any existing \textsl{Seq66} configuration files from the
