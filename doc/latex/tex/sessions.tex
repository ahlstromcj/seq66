...
\end{figure}
   ...
   \begin{itemize}
      ...
      \item The editable name of the log file to which to redirect warning
      ...
      \item Session Log File. If present, all console output goes into this
         log-file, which exists only in the "home" configuration directory.
      \item Last Directory. Shows the directory where the last MIDI file
         was loaded.
