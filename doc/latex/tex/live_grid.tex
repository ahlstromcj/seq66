...
\label{subsubsec:introduction_set_changer}
   ...
   See \sectionref{paragraph:menu_edit_preferences_play_options}.
...
\label{subsubsec:introduction_record_button}
   ...
   \begin{itemize}
      ...
      \item \textbf{Yellow}.
         ...
         See \sectionref{paragraph:menu_edit_preferences_midi_input}.
      \item \textbf{Green}.
...
\label{subsubsec:introduction_tap_bpm_button}
   ...
   By default, the \texttt{F9} key also operates this function, and
