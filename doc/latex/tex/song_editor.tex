...
%  It is inactive if there is nothing to redo.
   ...
   If enabled, it allows only full clips of the pattern to be added.
   ...
   If disabled, it allows the trigger to be smoothly extended in either
   direction, without snapping, when the mouse is moved left or right.
