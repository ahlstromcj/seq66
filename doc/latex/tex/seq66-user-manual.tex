...
\label{subsec:improvements}
   ...
   \begin{itemize}
      ...
      \item Improved the song editor tab for laying out patterns;
         ...
         can be opened in a tab or its own window.
      \item The mutes editor tab, improves mutes handling and control.
      \item A playlist editor tab with improved flexibility.
      \item A sets editor tab.
      \item A events editor tab to fix minor event issues and add meta text
         events.
      ...
      \item Repartitioning of configuration files into separate files for
         flexibility; added a color palette file,
         Qt style-sheets (\texttt{*.qss});
         an enhanced keystroke and MIDI 'ctrl' file, with
      ...
      \item Providing for routing of MIDI input events to
         patterns based on port number.
      \item Export songs in SMF 0 and 1 formats.
