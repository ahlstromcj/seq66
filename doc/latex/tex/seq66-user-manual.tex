...
\label{subsec:introduction_lets_go}
   ...
   \textsl{Seq66} does not support
   \index{pipewire}
   Pipewire.
   It may work with a Pipewire-JACK setup, but that usage has not been
   tested.
...
%  \includegraphics[scale=0.65]{main-window/main-window-light-gridstyle-3-markup.png}
   \includegraphics[scale=0.65]{main-window/main-window-0_98_6-annotated.png}
...
\subsubsection{Patterns Panel (Live Grid)}
\label{subsubsec:introduction_main_live_grid}
   ...
   Also shown in the patterns panel are a metronome button, 
   a grid-mode dropdown to control how the grid is used,
...
\paragraph{Live Song Record Button}
