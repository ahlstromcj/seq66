...
\label{sec:introduction}
   ...
   \textsl{Sequencer64}, through version 0.94.0.
...
\label{paragraph:introduction_ppqn_selection}
   ...
   to other values:
%  \texttt{32, 48, 96, 192, 384, 768, 960, 1920, 3840, 7680, 9600, 19200}.
   \texttt{32, 48, 96, 192, 384, 768, 960, 1920}.
   Currently, 1920 is the limit, because redrawing starts to really slow down
   after that.
...
\label{paragraph:introduction_sets_buss_override}
   ...
   Port-mapping is a useful way to redirect the set to a different output device;
   it can be used to provide a full set of virtual devices that any of the user's
   sequences can depend on.
