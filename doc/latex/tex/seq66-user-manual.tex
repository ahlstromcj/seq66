...
\label{sec:introduction}
   ...
   \textsl{Sequencer64}, through version 0.98.5.
...
\label{subsubsec:introduction_main_bottom_controls}
   ...
   \begin{itemize}
      \item \textbf{Set Name}
      \item \textbf{Uderrun Indicator} (not shown)
...
\paragraph{Underrun Indicator}
\label{paragraph:introduction_underrun_indicator}
   ...
   of events, this field will start flashing numbers, which indicate the
