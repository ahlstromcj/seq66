...
\label{sec:introduction}
   ...
   \textsl{Sequencer64}, through version 0.91.6.
...
\label{paragraph:introduction_}
   ...
   0.91.6.  It can currently show existing sets in one view.
...
% Man page.  Kind of useless, takes up space.  Leave it commented out.
%
%%% \input{manpage}
