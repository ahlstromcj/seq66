...
\label{paragraph:patterns_automation_control_out}
   ...
   An asterisk "*" indicates we don't like something about the behavior and
   might fix it. See the notes about those after the table.
   For example, currently, pressing "Panic" causes the \textbr{Panic}
   and \textbr{Stop buttons} to turn green, which seems silly in hindsight.
   ...
   \begin{table}[H]
      ...
      \begin{tabular}{l l l l}
         ...
         \textbf{Panic *} & On (R) & Off (R) & Inactive \\
         \textbf{Stop *} & On (R) & Off (R) & Inactive \\
         \textbf{Pause *} & On (Y) & Off (R) & Inactive \\
         \textbf{Play *} & On (G) & Off (R) & Inactive \\
         \textbf{Toggle Mutes *} & On (G) & Off (R) & Inactive \\
      \end{tabular}
   \end{table}
