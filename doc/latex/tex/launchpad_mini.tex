...
\label{paragraph:patterns_automation_control_out}
   ...
   \begin{verbatim}
      ...
      0 [ 0x0    0  0 ] [ 0x0    0 0 ] # queue on/off
      0 [ 0x0    0  0 ] [ 0x0    0 0 ] # oneshot on/off
      0 [ 0x0    0  0 ] [ 0x0    0 0 ] # replace on/off
      0 [ 0x0    0  0 ] [ 0x0    0 0 ] # snap1 store/restore
      0 [ 0x0    0  0 ] [ 0x0    0 0 ] # snap2 store/restore
      0 [ 0x0    0  0 ] [ 0x0    0 0 ] # learn on/off
   \end{verbatim}
