...
Windows support:
    ...
    However, the Qt 5 GUI removes some of the overly-convoluted features of the
    Gtkmm 2.4 GUI, while adding a mutes-master and a set-master tab.
    It is about 95% complete and very useable.

    Note that, currently, manual configuration of the "rc" and "usr" files is
    necessary.  Also supported are separate "ctrl" (MIDI control, input and
    output) and "mutes" files.  See the READMEs for more information.
